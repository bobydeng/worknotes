...
*/
  ...
  #define COOLANT_MIST_BIT   3 // MEGA2560 Digital Pin 5 - Ramps 1.4 Servo 3 Signal pin

  // Define flood and mist coolant enable output pins.
  #define SPINDLE_ENABLE_DDR      DDRF
  #define SPINDLE_ENABLE_PORT     PORTF
  #define SPINDLE_ENABLE_BIT      3 // Pin A3 - RAMPS Aux 1 Port
  #define SPINDLE_DIRECTION_DDR   DDRF
  #define SPINDLE_DIRECTION_PORT  PORTF
  #define SPINDLE_DIRECTION_BIT   4 // Pin A4 - RAMPS Aux 1 Port
...
#define SERVO
  ...
  // Advanced Configuration Below You should not need to touch these variables
  // Set Timer up to use TIMER4A which is attached to Digital Pin 6 which is Servo 2 signal pin on Ramps 1.4 board
  #define SPINDLE_PWM_MAX_VALUE   5242.9 // 16*1024*1024/8/400   2.5ms
  #ifndef SPINDLE_PWM_MIN_VALUE
  #define SPINDLE_PWM_MIN_VALUE   1049 //(SPINDLE_PWM_MAX_VALUE/5)   // 0.5ms
  #endif
  #define SPINDLE_PWM_OFF_VALUE     0
  #define SPINDLE_PWM_RANGE         (SPINDLE_PWM_MAX_VALUE-SPINDLE_PWM_MIN_VALUE)
  ...
  #define SPINDLE_OCRA_TOP_VALUE  41943 // 16*1024*1024/8/50, Translates to about 50Hz PWM frequency at 1/8 prescaler
